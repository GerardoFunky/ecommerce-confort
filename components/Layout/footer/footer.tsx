    ...
    <footer className="bg-gray-100 border-t">
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900">TiendaNext</h3>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:col-span-2">
            <FooterLinks
              ...
              links={[
                ...
                { name: "Nuevos", href: "/products?new=true" },
            ...
            <FooterLinks
              ...
              links={[
                ...
                { name: "Blog", href: "/blog" },
                { name: "Tiendas físicas", href: "/stores" },
              ]}
            />
            <FooterLinks
              title="Ayuda"
              links={[
                ...
                { name: "Términos y condiciones", href: "/policies/terms" },
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} TiendaNext. Todos los derechos
            reservados.
          </p>
